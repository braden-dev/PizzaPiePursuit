...
public class ButtonHelperFunctions : MonoBehaviour
{
    ...
    {
        StartCoroutine(PlayClickSoundAndWait(gameControls.StartLevel4));
    }
    ...
    public void ReturnToGameFromLevelSelect()
    {
        StartCoroutine(PlayClickSoundAndWait(gameControls.HideStartLevelMenu));
    }
